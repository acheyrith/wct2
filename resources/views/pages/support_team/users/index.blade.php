    ...
    <div class="card-body">
        <ul class="nav nav-tabs nav-tabs-highlight">
            ...
            <li class="nav-item dropdown">
                ...
                <a href="#ut-{{ Qs::hash($user_types[0]->id) }}" class="dropdown-item" data-toggle="tab">{{ $user_types[0]->name }}s</a>
            </li>
        </ul>
                ...
                <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-store" action="{{ route('users.store') }}" data-fouc>
                    ...
                    <fieldset>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select required data-placeholder="Select User" class="form-control select" name="user_type" id="user_type">
                                        ...
                                        <option value="{{ Qs::hash($user_types[0]->id) }}">{{ $user_types[0]->name }}</option>
                        ...
                        <div class="row">
                            {{--State--}}
                            <div class="col-md-4">
                                <label for="state_id">Province/Capital: <span class="text-danger">*</span></label>
